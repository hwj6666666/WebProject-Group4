  ...
  const goReg=()=>{
    ...
    return <>
      ...
      >
            ...
            {loginBox&&<><p className="flex justify-center mb-5 mt-10">请登录</p>
            <Form validateTrigger="onBlur"  onFinish={onFinish}  >  
                ...
                <Form.Item style={{display:'flex',alignItems:'center', flexDirection:'column'}}>
                    <div>没有账号?<span className="text-green-300" onClick={goReg}>前往注册</span></div>
            ...
            {regBox&& <><p className="flex justify-center mb-5 mt-10">请登录</p>
            <Form validateTrigger="onBlur"  onFinish={onFinishReg}  >  
                ...
                <div>已有账号?<span className="text-green-300" onClick={goLogin}>前往登录</span></div>
            </Form></>}
      </Modal></>
}